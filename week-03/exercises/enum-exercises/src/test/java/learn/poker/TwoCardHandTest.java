...
class TwoCardHandTest {
    ...
    void twoQueensShouldBeatTwo10s() {
        ...
        TwoCardHand queenQueen = new TwoCardHand(new Card(Rank.QUEEN, Suit.HEARTS), new Card(Rank.QUEEN, Suit.HEARTS));
        TwoCardHand tenTen = new TwoCardHand(new Card(Rank.TEN, Suit.HEARTS), new Card(Rank.TEN, Suit.HEARTS));
