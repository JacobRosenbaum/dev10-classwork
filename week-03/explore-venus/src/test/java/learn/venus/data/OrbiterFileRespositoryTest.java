...
class OrbiterFileRepositoryTest {
    ...
    @Test
    void shouldFindAllOrbiters() throws DataAccessException {
    ...
    void shouldNotFindMissingOrbiter() throws DataAccessException {
        Orbiter wrong = repository.findById(12345);
    ...
    void shouldAddOrbiter() throws DataAccessException {
        ...
        orbiter.setType(OrbiterType.VENUSIAN);
        orbiter.setName("Test Name");
    ...
    void shouldDeleteExisting() throws DataAccessException {
        ...
        Orbiter o = repository.findById(4);
        assertNull(o);
    }
